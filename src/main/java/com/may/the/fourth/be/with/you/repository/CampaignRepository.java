...
public interface CampaignRepository extends MongoRepository<Campaign, String>{
	...
	List<Campaign> findByBeginValidityLessThanEqualAndEndValidityGreaterThanEqualAndHeartTeamId(LocalDate beginValidity, LocalDate endValidity, String heartTeamId);
